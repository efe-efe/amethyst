...
--------------------------------------------------------------------------------
-- Ability Start
function weaver_basic_attack:OnSpellStart()
...
--------------------------------------------------------------------------------
-- Projectile
function weaver_basic_attack:OnProjectileHit_ExtraData( hTarget, vLocation, extraData )
...
function weaver_basic_attack:GetIntrinsicModifierName()
	return "modifier_weaver_basic_attack"
end

function weaver_basic_attack:GetCastRange( hTarget, vLocation, extraData )
