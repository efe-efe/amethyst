...
LinkLuaModifier( "modifier_spectre_basic_attack_charged_lua", "abilities/heroes/spectre/spectre_basic_attack/modifier_spectre_basic_attack_charged_lua", LUA_MODIFIER_MOTION_NONE )
...
function spectre_basic_attack_charged_lua:OnEndPseudoCastPoint()
	...
	local projectile = {
		...
		OnUnitHit = function(_self, unit) 
			...
			_self.Source:Heal( heal_amount, _self.Source )
...
function spectre_basic_attack_charged_lua:Animate(point, attack_speed)
	local caster = self:GetCaster()
	local origin = caster:GetOrigin()
