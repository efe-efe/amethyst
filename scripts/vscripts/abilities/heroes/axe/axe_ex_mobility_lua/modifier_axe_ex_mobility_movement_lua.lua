...
--------------------------------------------------------------------------------
-- Classifications
function modifier_axe_ex_mobility_movement_lua:IsHidden()
	return true
end

function modifier_axe_ex_mobility_movement_lua:IsPurgable()
	return false
end

--------------------------------------------------------------------------------
-- Initializations
function modifier_axe_ex_mobility_movement_lua:OnCreated( kv )
	if IsServer() then
...
function modifier_axe_ex_mobility_movement_lua:OnRefresh( kv )
end

function modifier_axe_ex_mobility_movement_lua:OnDestroy( kv )
	if IsServer() then
...
--------------------------------------------------------------------------------
-- Motion effects
function modifier_axe_ex_mobility_movement_lua:SyncTime( iDir, dt )
...
function modifier_axe_ex_mobility_movement_lua:UpdateHorizontalMotion( me, dt )
	self:SyncTime(1, dt)
...
function modifier_axe_ex_mobility_movement_lua:OnHorizontalMotionInterrupted()
	if IsServer() then
		self:Destroy()
	end
end

function modifier_axe_ex_mobility_movement_lua:UpdateVerticalMotion( me, dt )
	self:SyncTime(2, dt)
	local parent = self:GetParent()
...
function modifier_axe_ex_mobility_movement_lua:OnVerticalMotionInterrupted()
	if IsServer() then
		self:Destroy()
	end
end
...
--------------------------------------------------------------------------------
-- Modifier Effects
function modifier_axe_ex_mobility_movement_lua:DeclareFunctions()
	local funcs = {
...
-- Status Effects
function modifier_axe_ex_mobility_movement_lua:CheckState()
	local state = {
...
--[[
function modifier_axe_ex_mobility_movement_lua:GetOverrideAnimation()
	return ACT_DOTA_FLAIL
end
]]

function modifier_axe_ex_mobility_movement_lua:PlayEffects_a()
	if IsServer() then
		-- Create sound
...
function modifier_axe_ex_mobility_movement_lua:PlayEffects_b()
...
function modifier_axe_ex_mobility_movement_lua:StopEffects_b()
