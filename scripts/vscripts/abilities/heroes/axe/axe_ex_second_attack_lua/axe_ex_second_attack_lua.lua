...
LinkLuaModifier( "modifier_axe_ex_second_attack_movement_lua", "abilities/heroes/axe/axe_ex_second_attack_lua/modifier_axe_ex_second_attack_movement_lua", LUA_MODIFIER_MOTION_BOTH )
...
function axe_ex_second_attack_lua:OnSpellStart()
    ...
    for _,enemy in pairs(enemies) do
        ...
        enemy:AddNewModifier(
            ...
            self, -- ability source
            "modifier_axe_ex_second_attack_movement_lua", -- modifier name
            {
                x = x,
                y = y,
	...
	local alternate_version = caster:FindAbilityByName("axe_second_attack_lua")
