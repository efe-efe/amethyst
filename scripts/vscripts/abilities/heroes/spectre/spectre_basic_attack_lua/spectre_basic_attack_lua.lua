...
--------------------------------------------------------------------------------
--Passive Modifier
function spectre_basic_attack_lua:GetIntrinsicModifierName()
	return "modifier_spectre_basic_attack_lua"
end
...
function spectre_basic_attack_lua:OnEndPseudoCastPoint()
	...
	local modifier = caster:FindModifierByName("modifier_spectre_basic_attack_lua")
...
function spectre_basic_attack_lua:OnUpgrade()
...
function spectre_basic_attack_lua:PlayEffects_a()
	local caster = self:GetCaster()
	-- Create Particles
...
function spectre_basic_attack_lua:PlayEffects_d( pos )
	local caster = self:GetCaster()
	-- Create Particles
...
function spectre_basic_attack_lua:PlayEffects_e( hTarget )
	-- Create Sound
