modifier_sniper_second_attack_timer = class({})

function modifier_sniper_second_attack_timer:OnCreated()
    if IsServer() then
...
function modifier_sniper_second_attack_timer:OnDestroy()
    if IsServer() then
        local parent = self:GetParent()
...
function modifier_sniper_second_attack_timer:PlayEffects()
