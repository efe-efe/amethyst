...
function tinker_counter_lua:Refract( source, targets, jumps )
	-- load data
...
function tinker_counter_lua:OnEndPseudoCastPoint()
	-- load data
	local caster = self:GetCaster()
	local duration = self:GetSpecialValueFor("duration")
	local damage = self:GetSpecialValueFor("damage")
	...
	local alternate_version = caster:FindAbilityByName("tinker_ex_counter_lua")
	alternate_version:StartCooldown(self:GetCooldown(0))
end

--------------------------------------------------------------------------------
function tinker_counter_lua:PlayEffects_a( source, target )
	-- Get Resources
...
--------------------------------------------------------------------------------
function tinker_counter_lua:PlayEffects_b( source, point )
	-- Get Resources
	local particle_cast = "particles/units/heroes/hero_tinker/tinker_laser.vpcf"
	local sound_cast = "Hero_Tinker.Laser"
	local sound_target = "Hero_Tinker.LaserImpact"
