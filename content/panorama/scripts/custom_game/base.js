...
function SetTeamColors(){
    ...
    GameUI.CustomUIConfig().team_colors[DOTATeam_t.DOTA_TEAM_CUSTOM_1] = "#3dd296;"; // { 197, 77, 168 }	--		Pink
    GameUI.CustomUIConfig().team_colors[DOTATeam_t.DOTA_TEAM_CUSTOM_2] = "#F3C909;"; // { 255, 108, 0 }		--		Orange
}
