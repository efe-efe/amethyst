...
function CustomPlayerHeroNPC.prototype.ValdateUpgradeAttackCapabilities(self, upgrade)
    ...
    if self.unit:GetAttackCapability() ~= upgrade.attackCapability then
        return false
    end
    return true
end
