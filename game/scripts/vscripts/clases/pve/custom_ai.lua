...
____exports.CustomAIMeta = {
    ...
    [____exports.NPCNames.DIRE_ZOMBIE] = {
        factory = function(____, origin)
            ...
            ai.unit:AddNewModifier(
                ai.unit,
                nil,
                "modifier_shield",
                {
                    damage_block = ai.unit:GetMaxHealth()
                }
            )
            return ai
        end,
