...
____exports.default = (function()
    ...
    function Stage.prototype.OnHeroUpgrade(self)
        if self.room then
            self.room:OnHeroUpgrade()
        end
    end
    function Stage.prototype.OnBountySelected(self)
        if self.room then
            self.room:OnBountySelected()
        end
    end
