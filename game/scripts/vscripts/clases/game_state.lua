...
____exports.CustomGameState.PRE_LEVEL = 5
____exports.CustomGameState[____exports.CustomGameState.PRE_LEVEL] = "PRE_LEVEL"
____exports.CustomGameState.LEVEL_IN_PROGRESS = 6
____exports.CustomGameState[____exports.CustomGameState.LEVEL_IN_PROGRESS] = "LEVEL_IN_PROGRESS"
