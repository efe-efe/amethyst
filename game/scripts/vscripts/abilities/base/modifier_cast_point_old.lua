modifier_cast_point_old = class({})

local COOLDOWN_BY_CANCEL = 0.5

--------------------------------------------------------------------------------
-- Classifications
function modifier_cast_point_old:IsHidden()
	return true
end

function modifier_cast_point_old:IsDebuff()
	return true
end

function modifier_cast_point_old:IsStunDebuff()
	return false
end

function modifier_cast_point_old:IsPurgable()
	return false
end
...
--------------------------------------------------------------------------------
-- Initializer
function modifier_cast_point_old:OnCreated(params)
...
--------------------------------------------------------------------------------
-- When refreshed
function modifier_cast_point_old:OnRefresh(params)
...
function modifier_cast_point_old:SwapActiveSpells( mode )
	local boolean_mode
...
function modifier_cast_point_old:StartCast()
	if IsServer() then
...
function modifier_cast_point_old:StopCast()
	if IsServer() then
...
--------------------------------------------------------------------------------
-- Destroyer
function modifier_cast_point_old:OnDestroy(params)
...
--------------------------------------------------------------------------------
-- Interval Effects
function modifier_cast_point_old:OnIntervalThink()
...
--------------------------------------------------------------------------------
-- Modifier Effects
function modifier_cast_point_old:DeclareFunctions()
	local funcs = {
...
function modifier_cast_point_old:GetModifierMoveSpeedBonus_Percentage()
	if self.movement_speed ~= nil then
		return - (100 - self.movement_speed)
	end
end

function modifier_cast_point_old:OnOrder(params)
...
function modifier_cast_point_old:OnTakeDamage( params )
	if IsServer() then
...
--------------------------------------------------------------------------------
-- Status Effects
function modifier_cast_point_old:CheckState()
    if self.can_walk == 0 then
...
--------------------------------------------------------------------------------
-- Graphics
function modifier_cast_point_old:PlayEffects()
...
function modifier_cast_point_old:StopEffects()
...
function modifier_cast_point_old:UpdateEffects(origin)
	if self.no_target ~= 1 then
