...
local COLLIDE_OFFSET = 10
local COLLIDE_OFFSET_MINI = 1

local COLLIDE_SLOW_FACTOR = 1.5
local COLLIDE_SUPER_SLOW_FACTOR = 3.0
...
--------------------------------------------------------------------------------
-- Classifications
function modifier_hero_base:IsHidden()
	return true
end

function modifier_hero_base:IsDebuff() return false
end

function modifier_hero_base:IsStunDebuff()
	return false
end

function modifier_hero_base:IsPurgable() return false
end

function modifier_hero_base:RemoveOnDeath()
    return false
end

--------------------------------------------------------------------------------
-- Initializer
function modifier_hero_base:OnCreated(params)
...
function modifier_hero_base:Move()
...
function modifier_hero_base:GetColliding(test_position_front, actual_z, color)
...
function modifier_hero_base:GetCollidingWithObjects(test_position)
...
function modifier_hero_base:SubMove(colliding, origin, speed, direction_a, direction_b, slow)
...
function modifier_hero_base:GetDisableAutoAttack()
    return true
end
