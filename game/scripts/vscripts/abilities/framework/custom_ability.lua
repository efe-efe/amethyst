...
function CustomAbility.prototype.ProjectileAttack(self, options)
    ...
    local distance = options.distance and options.distance or (valueDistance ~= 0 and valueDistance or self:GetCastRange(
        Vector(0, 0, 0),
        nil
    ))
