modifier_pudge_mobility = class({})

---------------------------------------------------------------------------------
-- Initializer
function modifier_pudge_mobility:OnCreated(params)
    if IsServer() then
        self.effects_cast = {}
        self.counter = 0
        self.index = 0
...
function modifier_pudge_mobility:OnDestroy()
    if IsServer() then
        self:StopEffects()
    end
end
...
--------------------------------------------------------------------------------
-- Interval Effects
function modifier_pudge_mobility:OnIntervalThink()
...
function modifier_pudge_mobility:PlayEffects(index)
...
function modifier_pudge_mobility:StopEffects()
