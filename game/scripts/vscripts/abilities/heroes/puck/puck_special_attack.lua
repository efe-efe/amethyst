...
function ModifierPuckSpecialAttack.prototype.OnCreated(self, params)
    ...
    if IsServer() then
        ...
        self.stunDuration = params.stunDuration
        self.fairyDustDuration = params.fairyDustDuration
        self.fairyDustSlowPct = params.fairyDustSlowPct
