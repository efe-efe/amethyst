sniper_counter_lua = class({})
LinkLuaModifier( "modifier_sniper_counter_lua", "abilities/heroes/sniper/sniper_counter_lua/modifier_sniper_counter_lua", LUA_MODIFIER_MOTION_NONE )

function sniper_counter_lua:OnSpellStart() 
    ...
    caster:AddNewModifier(
        caster,
        self,
        "modifier_sniper_counter_lua",
        {duration = duration}
    )

end

function sniper_counter_lua:PlayEffects()
    local caster = self:GetCaster()
