...
function mars_special_attack:OnSpellStart()
	...
	local stacks = CustomEntitiesLegacy:SafeGetModifierStacks(caster, "modifier_mars_basic_attack_stacks")
	...
	CustomEntitiesLegacy:SafeDestroyModifier(caster, "modifier_mars_basic_attack_stacks")
