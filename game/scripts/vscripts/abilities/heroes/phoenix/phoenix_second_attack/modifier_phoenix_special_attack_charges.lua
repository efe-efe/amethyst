modifier_phoenix_special_attack_charges = class({})

--- Misc 
function modifier_phoenix_special_attack_charges:IsHidden()
    return false
end

function modifier_phoenix_special_attack_charges:DestroyOnExpire()
    return false
end
...
function modifier_phoenix_special_attack_charges:DeclareFunctions()
    local funcs = {
...
--------------------------------------------------------------------------------
-- Interval Effects
function modifier_phoenix_special_attack_charges:OnIntervalThink()
	self:SetStackCount(self.max_charges)
