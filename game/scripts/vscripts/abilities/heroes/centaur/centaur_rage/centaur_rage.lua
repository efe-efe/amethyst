...
LinkLuaModifier("modifier_centaur_rage_channeling", "abilities/heroes/centaur/centaur_rage/modifier_centaur_rage_channeling", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_centaur_rage_thinker", "abilities/heroes/centaur/centaur_rage/modifier_centaur_rage_thinker", LUA_MODIFIER_MOTION_NONE)
