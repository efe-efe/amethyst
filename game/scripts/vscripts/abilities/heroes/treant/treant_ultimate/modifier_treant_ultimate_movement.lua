modifier_treant_ultimate_movement = class({})

--------------------------------------------------------------------------------
-- Classifications
function modifier_treant_ultimate_movement:IsHidden()
	return true
end

function modifier_treant_ultimate_movement:IsDebuff()
	return true
end

function modifier_treant_ultimate_movement:IsStunDebuff()
	return false
end
...
--------------------------------------------------------------------------------
-- Modifier Effects
function modifier_treant_ultimate_movement:DeclareFunctions()
	local funcs = {
...
--------------------------------------------------------------------------------
-- Status Effects
function modifier_treant_ultimate_movement:CheckState()
	local state = {
...
--------------------------------------------------------------------------------
-- Graphics & animations
function modifier_treant_ultimate_movement:GetOverrideAnimation()
