...
function modifier_sky_special_attack_thinker:IsHidden()
	return true
end
...
--On think
--------------------------------------------------------------------------------
function modifier_sky_special_attack_thinker:OnIntervalThink()
...
function modifier_sky_special_attack_thinker:PlayEffects()
    -- Get Resources
