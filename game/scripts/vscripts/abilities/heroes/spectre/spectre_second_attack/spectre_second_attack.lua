...
function spectre_second_attack:OnCastPointEnd()
	...
	local projectile = {
		...
		OnThinkBegin = function(_self)
			...
			ParticleManager:SetParticleControl( effect_cast, 0, _self.current_position )
			ParticleManager:SetParticleControl( effect_cast, 1, _self.current_position )
			ParticleManager:SetParticleControl( effect_cast, 2, _self.current_position )
