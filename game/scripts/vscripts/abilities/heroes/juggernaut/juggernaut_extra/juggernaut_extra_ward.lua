juggernaut_extra_ward = class({})

function juggernaut_extra_ward:OnCreated()
...
function juggernaut_extra_ward:OnDestroy()
    if IsServer() then
...
--------------------------------------------------------------------------------
-- Interval Effects
function juggernaut_extra_ward:OnIntervalThink()
