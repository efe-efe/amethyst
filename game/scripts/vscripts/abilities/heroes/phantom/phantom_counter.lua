...
function PhantomCounterRecast.prototype.OnSpellStart(self)
    ...
    local phantomCounter = self.caster:FindAbilityByName("phantom_counter")
...
function PhantomExCounterRecast.prototype.OnSpellStart(self)
    ...
    local phantomExCounter = self.caster:FindAbilityByName("phantom_ex_counter")
...
function ModifierPhantomCounter.prototype.DeclareFunctions(self)
    return {MODIFIER_PROPERTY_OVERRIDE_ANIMATION, MODIFIER_PROPERTY_OVERRIDE_ANIMATION_RATE, MODIFIER_EVENT_ON_ORDER}
end
...
function ModifierPhantomCounterBanish.prototype.OnDestroy(self)
    ...
    if IsServer() then
        ...
        local phantomBasicAttack = self.parent:FindAbilityByName(PhantomBasicAttack.name)
