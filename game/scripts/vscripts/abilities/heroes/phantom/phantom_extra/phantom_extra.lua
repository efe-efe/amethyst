...
function phantom_extra:OnCastPointEnd( point )
    local caster = self:GetCaster()
...
-- On Spell start
function phantom_extra:PlayEffects_a()
    -- Cast Sound
...
function phantom_extra:PlayEffects_b( pos )
	local caster = self:GetCaster()
	local offset = 120
	local origin = caster:GetOrigin()
...
function phantom_extra:PlayEffects_c( hTarget )
    -- Cast Sound
