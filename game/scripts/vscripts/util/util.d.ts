...
declare function CreateTimedRadiusMarker(this: void, hEntity: CDOTA_BaseNPC | undefined, origin: Vector, radius: number, delay: number, duration: number, scope: number): object;
