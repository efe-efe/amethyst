...
exports.Keywords =
  exports.multipleKeywords =
  exports.Ability =
  exports.Description =
  exports.UpgradeTypes =
  exports.Upgrades =
    void 0;
...
exports.Keywords = {
  ...
  PhantomStack: createKeyword({
    ...
    description:
      "Extra effects on " +
      exports.Ability("Critical Strike", "phantom_second_attack.png") +
      ", " +
      exports.Ability("Coup De Grace", "phantom_ultimate.png") +
      ", and " +
      exports.Ability("Blur Strike", "phantom_ex_counter.png") +
      ".",
  ...
  FuryStack: createKeyword({
    ...
    description:
      "Extra effects on " +
      exports.Ability("Blade Dance", "juggernaut_second_attack.png") +
      ", " +
      exports.Ability("Omnislash", "juggernaut_ultimate.png") +
      " and " +
      exports.Ability("Weakspot", "juggernaut_ex_second_attack.png") +
      ".",
  ...
  Desolate: createKeyword({
    ...
    description:
      ...
      exports.Ability("Void Strike", "spectre_basic_attack.png") +
      ".",
