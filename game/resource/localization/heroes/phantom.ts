...
export function GenerateLocalizationData(): LocalizationData {
  ...
  const CriticalStrike = Ability(
    "Critical Strike",
    "phantom_second_attack.png"
  );
  const LesserStiflingDagger = Ability(
    "Lesser Stifling Dagger",
    "phantom_basic_attack_related.png"
  );
  const PoisonusDagger = Ability(
    "Poisonus Dagger",
  ...
  Abilities.push({
    ...
    description: Description({
      description:
        ...
        Keywords.PhantomStack.instance() +
  ...
  Abilities.push({
    ...
    description: Description({
      ...
      level:
        ...
        Keywords.Bleeding.instance() +
        ".",
    }),
    lore: multipleKeywords([
      Keywords.Bleeding.definition,
      Keywords.FadingSlow.definition,
      Keywords.PhantomStack.definition,
    ]),
    ability_specials: [
      {
        ability_special: "AbilityCastPoint",
