...
function GenerateLocalizationData() {
  ...
  Abilities.push({
    ...
    description: specific_1.Description({
      description:
        "Fire with your gun @{max_charges} times before reloading, dealing " +
  ...
  Abilities.push({
    ...
    description: specific_1.Description({
      description:
        "Fire a piercing shot that deals @{ability_damage} damage and inflicts " +
        specific_1.Keywords.Stun.instance() +
        " for @{stun_duration}s. Damage is reduced @{reduction_per_hit} % per target hit.",
      level:
        "Reduces the damage but also reduces the cast point and allows you to cast it while moving.",
    }),
  ...
  Abilities.push({
    ...
    description: specific_1.Description({
      description:
        "Becomes invisible for @{duration}s. Moves @{speed_buff_pct} % faster while invisible. Resets the cooldown of " +
        Snipe +
        ".",
  ...
  Abilities.push({
    ...
    description: specific_1.Description({
      description:
        "Dash towards a new location, while creating a " +
        Shrapnel +
  ...
  Abilities.push({
    ...
    description: specific_1.Description({
      description:
        "Fire 4 rockets dealing @{ability_damage} damage on hit and @{aoe_damage} damage on the explosion.",
      channeled: true,
    }),
  ...
  Abilities.push({
    ...
    description: specific_1.Description({
      description:
        "Fire a piercing shot that deals @{ability_damage} damage and inflicts " +
        specific_1.Keywords.Root.instance() +
        " for @{root_duration}s. Damage is reduced @{reduction_per_hit} per target hit.",
  ...
  Abilities.push({
    ...
    description: specific_1.Description({
      description:
        "Deploys a grenade that leaves the impact area covered in electricity, increasing the movement speed by @{ms_pct}% to the allies in the area and constatly reloading Sniper's " +
        DualShoot +
        " and increasing his " +
        specific_1.Keywords.BaseDamage +
        " in @{extra_damage}. Lasts for @{duration}s.",
