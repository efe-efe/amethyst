...
function GenerateLocalizationData() {
    ...
    Abilities.push({
        ...
        description: specific_1.Description({
            description: 'Swings your weapon in a melee attack, dealing ' + specific_1.Keywords.BaseDamage + ' to all enemies in front of you. Consumes all ' + specific_1.Keywords.PhantomStack.instance() + ' to increase the damage done by @{damage_per_stack} per stack. If you consume 3 stacks, instantly gives ' + Swift + ' a charge.',
    ...
    Abilities.push({
        ...
        description: specific_1.Description({
            description: 'Throws a dagger that deals ' + specific_1.Keywords.BaseDamage + ' to the target plus @{damage_modifier}, inflicts ' + specific_1.Keywords.FadingSlow.instance('@{fading_slow_pct}') + ' for @{fading_slow_duration}s and generates a ' + specific_1.Keywords.PhantomStack.instance() + '. You can stack up to @{max_charges} charges.',
