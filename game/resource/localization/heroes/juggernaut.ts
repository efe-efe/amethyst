...
export function GenerateLocalizationData(): LocalizationData {
  ...
  Abilities.push({
    ...
    description: Description({
      description:
        ...
        Keywords.Swiftness.instance("@{swiftness_pct}") +
  ...
  Abilities.push({
    ...
    lore: multipleKeywords([
      Keywords.FuryStack.definition,
      Keywords.Sleep.definition,
      Keywords.Swiftness.definition,
    ]),
    ability_specials: [
      {
        ability_special: "AbilityCastPoint",
