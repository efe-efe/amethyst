...
export function GenerateLocalizationData(): LocalizationData {
  ...
  const EndlessMisschief = Ability(
    "Endless Mischief",
  ...
  Abilities.push({
    ...
    description: Description({
      description:
        ...
        Keywords.FairyDust.instance("@{fairy_dust_slow_pct}") +
  ...
  Abilities.push({
    ...
    description: Description({
      description:
        ...
        Keywords.SpellBlock.instance("@{silence_duration}") +
        " for @{pre_silence_duration}s on the enemy units nearby.",
      level:
        "Grants one free recast if " +
        Keywords.SpellBlock.instance() +
        " is triggered.",
    }),
    lore: multipleKeywords([
      Keywords.SpellBlock.definition,
      Keywords.Silence.definition,
    ]),
    ability_specials: [
      {
