...
function GenerateLocalizationData() {
    ...
    Abilities.push({
        ...
        name: 'Spear attack',
        description: 'Melee attack that deals <b><font color=\\"#ffffff\\">base damage</font></b>. Successfully hitting a target generate a <b><font color=\\"#ff5d00 \\">Precision Stack</font></b>',
        notes: [
    ...
    Abilities.push({
        ...
        name: 'God\'s Rebuke',
        description: 'Mars smashes enemies in a cone in front of him with his shield, knocking them back and dealing ${multiplier} times his base attack and inflicts <b><font color=\\"#FFC1AA\\">Fading Slow</font></b>.\\n<b><font color=\\"#61ffd0\\"><img src=\\"file://{images}/custom_game/add.png\\" />LEVEL UPGRADE</font></b><br>Increases the damage multiplier.',
        notes: [
    ...
    Abilities.push({
        ...
        name: 'Bulwark',
        description: 'Mars wields his massive shield to block melee attack and reflect projectiles in front of him. Lasts for ${counter_duration}s.\\n<b><font color=\\"#61ffd0\\"><img src=\\"file://{images}/custom_game/add.png\\" />LEVEL UPGRADE</font></b><br>Increases duration.',
        ability_specials: [
            {
                ability_special: 'AbilityCastPoint',
                text: '<font color=\\"#B2B5B3\\">CAST POINT</font>',
    ...
    Abilities.push({
        ...
        name: 'Spear of Mars',
        description: 'Mars throws his legendary Spear with deadly precision, dealing ${ability_damage} to the first enemy unit it strikes. The target is also skewered on the spear, pushing it back. If a skewered hero hits a wall or a cliff, they will receive ${extra_damage} damage and be impaled to it and an <b><font color=\\"#94A551\\">Root</font></b> will be applied. Consumes all <b><font color=\\"#ff5d00 \\">Precision Stacks</font></b> and deal ${damage_per_stack} extra damage per stack consumed.\\n<b><font color=\\"#61ffd0\\"><img src=\\"file://{images}/custom_game/add.png\\" />LEVEL UPGRADE</font></b><br>Applies <b><font color=\\"#ffffff\\">Stun</font></b> instead of <b><font color=\\"#94A551\\">Root</font></b>.',
        notes: [
    ...
    Abilities.push({
        ...
        name: 'God\'s fall',
        description: 'Mars prepares and then leaps through the air to land at the indicated location, dealing ${ability_damage} damage to nearby enemies.\\n<b><font color=\\"#61ffd0\\"><img src=\\"file://{images}/custom_game/add.png\\" />LEVEL UPGRADE</font></b><br>Increments cast range.',
        ability_specials: [
            {
                ability_special: 'AbilityCastPoint',
                text: '<font color=\\"#B2B5B3\\">CAST POINT</font>',
    ...
    Abilities.push({
        ...
        name: 'Arena Of Blood',
        description: 'Mars summons an arena lined with the undead warriors of the Ash Legion, who block enemy attacks and movement. Enemy heroes near the inside edge of the arena will be attacked by spears, dealing ${ability_damage} damage and knocking them back.',
        ability_specials: [
            {
                ability_special: 'AbilityCastPoint',
                text: '<font color=\\"#B2B5B3\\">CAST POINT</font>',
    ...
    Abilities.push({
        ...
        name: 'Summon Warrior',
        description: 'Mars summons an single warrior of the Ash Legion, who block enemy attacks and movement. Enemy heroes close to the warrior will be attacked by spears, dealing ${ability_damage} damage and knocking them back.\\n<b><font color=\\"#61ffd0\\"><img src=\\"file://{images}/custom_game/add.png\\" />LEVEL UPGRADE</font></b><br>Can be recasted.',
        ability_specials: [
            {
                ability_special: 'AbilityCastPoint',
                text: '<font color=\\"#B2B5B3\\">CAST POINT</font>',
    ...
    Abilities.push({
        ...
        description: 'Mars eats food that has been thrown by the crowd, healing himself for ${heal} health. Heal an additional ${heal_per_tick} health every ${think_interval}s during ${duration}s.\\n<b><font color=\\"#61ffd0\\"><img src=\\"file://{images}/custom_game/add.png\\" />LEVEL UPGRADE</font></b><br>Reduces the cooldown.',
        ability_specials: [
            {
                ability_special: 'AbilityCastPoint',
                text: '<font color=\\"#B2B5B3\\">CAST POINT</font>',
    ...
    Abilities.push({
        ...
        description: 'Mars smashes enemies in a cone in front of him with his shield, knocking them back and dealing ${ability_damage} and inflicting <b><font color=\\"#CB8CFF\\">Sleep</font></b>.\\n<b><font color=\\"#61ffd0\\"><img src=\\"file://{images}/custom_game/add.png\\" />LEVEL UPGRADE</font></b><br>Increases sleep duration',
        notes: [
    ...
    Abilities.push({
        ...
        name: 'Necromastery',
        description: 'Shadow Fiend launches a projectile that deals <b><font color=\\"#ffffff\\">base damage</font></b> and steals the <b><font color=\\"#ff2727 \\">Soul</font></b> from heroes he hits. Each <b><font color=\\"#ff2727 \\">Soul</font></b> gives Shadow Fiend ${damage_per_stack} damage.',
        ability_specials: [
            {
                ability_special: 'mana_gain_pct',
                text: '<font color=\\"#00A6DE\\">MANA GAIN</font>',
    ...
    Abilities.push({
        ...
        description: 'Counters the next projectile or melee attack. Countering an attack banishes yourself for ${banish_duration}s. Shadow Fiend appears on the mouse location. Enemies on the arrival area recives ${ability_damage} damage and gets <b><font color=\\"#DC8668 \\">Fear</font></b> for ${fear_duration}s.\\n<b><font color=\\"#61ffd0\\"><img src=\\"file://{images}/custom_game/add.png\\" />LEVEL UPGRADE</font></b><br>Increases the area of effect',
        notes: [
    ...
    Abilities.push({
        ...
        description: 'Shadow Fiend dashes towards the target direction, dealing ${ability_damage} damage and applying <b><font color=\\"#FFC1AA\\">Fading Slow</font></b> to all enemies on the path. Give 2 <b><font color=\\"#ff2727 \\">Souls</font></b> stacks per target hit.\\n<b><font color=\\"#61ffd0\\"><img src=\\"file://{images}/custom_game/add.png\\" />LEVEL UPGRADE</font></b><br>Increases the <b><font color=\\"#FFC1AA\\">Fading Slow</font></b> duration.',
        notes: [
            '<b><font color=\\"#FFC1AA\\">Fading Slow:</font></b> reduce movement speed by ${fading_slow_pct}% for ${fading_slow_duration}s. The effect decays linearly over time, gradually restoring the target\'s speed over the duration of this debuff.',
        ],
        ability_specials: [
    ...
    Abilities.push({
        ...
        description: 'Shadow Fiend gathers his captured souls to release them as demonic gargoyles that follows him for ${duration}. During that period of time, deals ${damage_per_think} damage plus extra ${damage_per_soul} per <b><font color=\\"#ff2727 \\">Soul</font></b> consumed every ${think_interval}s to enemies arround him. It also slows enemies for ${slow_pct}%.\\n<b><font color=\\"#61ffd0\\"><img src=\\"file://{images}/custom_game/add.png\\" />LEVEL UPGRADE</font></b><br>Increases the duration.',
    });
    Abilities.push({
        ability_classname: 'nevermore_ex_special_attack',
        name: 'Soul Eater',
        description: 'Shadow Fiend consumes all the captured <b><font color=\\"#ff2727 \\">Souls</font></b> to heals himself by ${heal} plus ${heal_per_soul} per <b><font color=\\"#ff2727 \\">Soul</font></b> consumed.\\n<b><font color=\\"#61ffd0\\"><img src=\\"file://{images}/custom_game/add.png\\" />LEVEL UPGRADE</font></b><br>Increases the base heal ammount.',
        ability_specials: [
            {
                ability_special: 'AbilityCastPoint',
                text: '<font color=\\"#B2B5B3\\">CAST POINT</font>',
    ...
    Abilities.push({
        ...
        description: 'Enemies near to Shadowfiend recives ${ability_damage} damage and gets <b><font color=\\"#DC8668 \\">Fear</font></b> for ${fear_duration}s.\\n<b><font color=\\"#61ffd0\\"><img src=\\"file://{images}/custom_game/add.png\\" />LEVEL UPGRADE</font></b><br>Increases the area of effect.',
        notes: [
            '<b><font color=\\"#DC8668\\">FEAR:</font></b> forces unit to move away from the Fear inflictor. Unit is unable to act while feared',
        ],
        ability_specials: [
    ...
    Modifiers.push({
        ...
        name: 'Inhibit',
        description: 'Moving slower. Every damage instance received reduces your mana.',
    });
    Modifiers.push({
    ...
    Modifiers.push({
        ...
        name: 'Healing',
        description: 'Healing hp per second. If the unit recives damage, the effect is lost',
    });
    Modifiers.push({
        modifier_classname: 'modifier_item_clarity_custom',
        name: 'Mana',
        description: 'Gaining mana per second. If the unit recives damage, the effect is lost',
    });
    Modifiers.push({
    ...
    Modifiers.push({
        ...
        name: 'Adrenaline',
        description: "Moving {" + "MODIFIER_PROPERTY_MOVESPEED_BONUS_PERCENTAGE" /* MOVESPEED_BONUS_PERCENTAGE */ + "}% faster. Removed on casting any ability or getting hit by an enemy ability.",
    });
    Modifiers.push({
