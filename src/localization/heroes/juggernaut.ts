...
const yurneroDash = abilityWithIcon(
  "Yurnero Dash",
  "juggernaut_counter_recast"
);
const bladeMastery = abilityWithIcon(
  "Blade Mastery",
...
localizeAbility("juggernaut_basic_attack", {
  ...
  upgrade: upgrade(
    `Successful hits also reduces the cooldown from ${preparation} and ${swiftslash}.`
  ),
...
localizeAbility("juggernaut_ex_second_attack", {
  ...
  lore: [
    furyStack.description,
    keywords.sleep.description,
