...
export default class HeroInfoCard {
  ...
  constructor(heroData: HeroData, alliancePanel: Panel) {
    ...
    this.containerPanel = panels.createPanelSimple(
      alliancePanel,
      "hero-info-card"
    );

    this.leftPanel = panels.createPanelSimple(
      this.containerPanel,
      "hero-info-card__left"
    );
    this.rightPanel = panels.createPanelSimple(
      this.containerPanel,
      "hero-info-card__right"
    );

    this.leftTopPanel = panels.createPanelSimple(
      this.leftPanel,
      "hero-info-card__top"
    );
    this.leftMidPanel = panels.createPanelSimple(
      this.leftPanel,
      "hero-info-card__mid"
    );
    this.leftBotPanel = panels.createPanelSimple(
      this.leftPanel,
      "hero-info-card__bot"
    );
    this.abilitiesPanel = panels.createPanelSimple(
      this.rightPanel,
      "hero-info-card__abilities"
    );
    ...
    const imagePanel = panels.createPanelSimple(
      this.leftTopPanel,
      "hero-info-card__image",
      "DOTAHeroImage"
    ) as HeroImage;
    const resourcesPanel = panels.createPanelSimple(
      this.leftMidPanel,
      "hero-info-card-resources"
    );
    this.healthPanel = panels.createPanelSimple(
      resourcesPanel,
      "hero-info-card-resources__health"
    );
    this.manaPanel = panels.createPanelSimple(
      resourcesPanel,
      "hero-info-card-resources__mana"
    );
