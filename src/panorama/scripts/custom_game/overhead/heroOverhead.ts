...
export default class HeroOverhead extends Overhead {
  ...
  constructor(heroData: HeroData) {
    ...
    this.topPanel = panels.createPanelSimple(
      this.containerPanel,
      "unit-overhead__top"
    );
    this.midPanel = panels.createPanelSimple(
      this.containerPanel,
      "unit-overhead__mid"
    );
    this.botPanel = panels.createPanelSimple(
      this.containerPanel,
      "unit-overhead__bot unit-overhead__bot--hero"
    );
    this.chargesPanel = panels.createPanelSimple(
      this.botPanel,
      "unit-overhead-charges"
    );
    const resourcesPanel = panels.createPanelSimple(
      this.botPanel,
      "unit-overhead-resources"
    );
    this.healthPanel = panels.createPanelSimple(
      resourcesPanel,
      "unit-overhead-resources__health"
    );
    this.manaPanel = panels.createPanelSimple(
      resourcesPanel,
      "unit-overhead-resources__mana"
    );
    this.energyPanel = panels.createPanelSimple(
      resourcesPanel,
      "unit-overhead-resources__energy"
    );

    this.castpointPanel = panels.createPanelSimple(
      resourcesPanel,
      "unit-overhead-resources__castpoint"
    );
    this.ammoPanel = panels.createPanelSimple(
      this.botPanel,
      "unit-overhead-ammo"
    );
    this.stackbarsPanel = panels.createPanelSimple(
      this.ammoPanel,
      "unit-overhead-ammo__stackbars"
    );
    this.cooldownPanel = panels.createPanelSimple(
      this.ammoPanel,
      "unit-overhead-ammo__cooldown"
    );
    ...
    this.midSwitchPanel = new SwitchPanel(
      player.GetPanel(),
      this.status.GetPanel()
    );
    this.botSwitchPanel = new SwitchPanel(
      this.cooldownPanel,
      this.stackbarsPanel
    );
