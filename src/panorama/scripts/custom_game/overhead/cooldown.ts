...
export default class Cooldown {
  ...
  constructor(
    ...
    this.backgroundPanel = panels.createPanelSimple(
      this.panel,
      "cooldown__background"
    );
    this.foregroundPanel = panels.createPanelSimple(
      this.panel,
      "cooldown__foreground"
    );
  ...
  Update(): void {
    ...
    if (modifierIndex) {
      ...
      if (duration == -1) {
        this.foregroundPanel.style.clip =
          "radial(50% 50%, 0deg, " + 360 + "deg)";
