...
const Items: Upgrade[] = [
  ...
  },
  {
    ...
    tier: 1,
    ingredients: [
      "upgrade_item_boots_of_elves",
      "upgrade_item_blade_of_alacrity",
    ],
  },
  {
  ...
  },
  {
    ...
    name: "Maelstrom",
    description:
      "Increases your base damage. Your attacks has a chance to release a bolt of electricity that leaps between enemy targets.",
    maxStacks: 1,
    modifier: {},
  ...
  },
  {
    ...
    name: "Basher",
    description:
      "Increases your maximum HP and your base damage. Your attacks has a chance to deal extra damage and stun the target.",
    maxStacks: 1,
    modifier: {},
