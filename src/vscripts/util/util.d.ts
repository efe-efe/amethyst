declare function SendOverheadHealMessage(
  this: void,
  hEntity: CDOTA_BaseNPC,
  nValue: number
): void;
declare function SendOverheadDamageMessage(
  this: void,
  hEntity: CDOTA_BaseNPC,
  nValue: number
): void;
declare function EFX(
  this: void,
  path: string,
  attach: ParticleAttachment,
  parent: CBaseEntity | undefined,
  options: any
): ParticleID;
